...
// (supabase/functions/import-worker/ocr.ts). What stayed here is the
// JSON → domain parser, which is exercised by Vitest tests so it keeps
// a copy of `parseLlmJson` in TypeScript land.
