 ...
 * `user_ocr_prefs`. Used as the starting values on the New import page; the
 * bakeoff page can "promote" a winning variant into these in one click.
 *
 * Extracted verbatim from the old monolithic SettingsPage so the LLM settings
 * tab composes uniform section cards like the others.
 */
export function OcrModelPromptSection() {
