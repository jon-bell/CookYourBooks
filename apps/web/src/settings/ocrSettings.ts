...
- description: any background text, introduction, or headnote about the recipe (null if not found). If the page ALSO shows clearly-related content that is not the recipe itself — a simple accompaniment, a serving suggestion, a variation, or a buying/ingredient guide — append a brief note about it to the END of the description, prefixed "On the page: ", so the cook can refer back to the page graphic. Keep it to a sentence or two and never invent content that isn't visibly present.
