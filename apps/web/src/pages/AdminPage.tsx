    ...
    <div className="mt-3 flex flex-wrap gap-2">
      ...
      {(report.target_type === 'COLLECTION' || report.target_type === 'USER') && (
        <button
          ...
          className="rounded-md border border-red-300 dark:border-red-700 px-3 py-1.5 text-sm text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/40"
        >
          Ban user
        </button>
      )}
      <button
        ...
        className="rounded-md border border-stone-300 dark:border-stone-600 px-3 py-1.5 text-sm text-stone-700 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800"
      >
        Dismiss
      </button>
    ...
    <ul className="space-y-2">
      {(data ?? []).map((a) => (
        ...
        >
          ...
          {a.reason && <span className="text-stone-700 dark:text-stone-300">— {a.reason}</span>}
